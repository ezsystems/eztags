...
// that index_treemenu_tags.php can assume that index.php does
...
$_SERVER['SCRIPT_FILENAME'] = str_replace( '/index_treemenu_tags.php', '/index.php', $_SERVER['SCRIPT_FILENAME'] );
$_SERVER['PHP_SELF'] = str_replace( '/index_treemenu_tags.php', '/index.php', $_SERVER['PHP_SELF'] );
