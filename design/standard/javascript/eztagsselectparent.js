jQuery(document).ready(function() {
	var
		parent_selector_buttons = jQuery('[id^="eztags-parent-selector-button-"]'),
		parent_selector_tree = jQuery('#parent-selector-tree'),
		parent_id, parent_keyword;

	parent_selector_buttons.click(function()
	{
		parent_id = jQuery('#' + jQuery(this).attr('id').replace('eztags-parent-selector-button-', 'eztags_parent_id_'));
		parent_keyword = jQuery('#' + jQuery(this).attr('id').replace('eztags-parent-selector-button-', 'eztags_parent_keyword_'));
