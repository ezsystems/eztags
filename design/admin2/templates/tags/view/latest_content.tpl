...
<h2>{'Latest content'|i18n( 'extension/eztags/tags/view' )} {if $nodes_count|gt(0)}{$view_parameters.offset|sum(1)}-{$nodes|count()|sum($view_parameters.offset)} of {$nodes_count}{/if}</h2>
